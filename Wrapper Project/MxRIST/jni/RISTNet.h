...
#include "rist/include/librist/librist.h"
#include "rist/include/librist/version.h"
#include <string.h>
#include <any>
#include <tuple>
#include <vector>
 ...
 * \brief
 *
 * A RISTNetReceiver receives data from a sender. The receiver can listen for a sender to connect
...
public:
     ...
     *
     * If the receiver is in listen mode and a sender connects this method is called
...
public:
     ...
     *
     * @param rPeerList is a vector of RIST formatted URLs and weights.
